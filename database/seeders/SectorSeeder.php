...
class SectorSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Sector::create([
            ...
            'subtitulo' => 'Un lugar único y exclusivo. Esta espectacular finca, destaca por su increíble entorno natural.',
            'tipo_id' => 2,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Uno de los rincones con más encanto de Aragón',
            'tipo_id' => 2,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Plena Naturaleza. Situada en un paraje espectacular de la comarca Gúdar – Javalambre,en Sarrión a 20 minutos de Teruel.',
            'tipo_id' => 2,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Un lugar de Ensueño.

            Situada en la cola del Pantano del Arquillo en el término turolense de San Blas, goza de una privacidad y unas vistas incomparables',
            'tipo_id' => 2,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'En pleno centro de Teruel. Una privacidad y unas vistas incomparables a los pies de la Torre de San Pedro.',
            'tipo_id' => 2,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'El Huerto de Bonet en Alginet (Valencia) es una finca rodeada de naranjos que data del siglo XVIII.',
            'tipo_id' => 2,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Un ambiente cálido y acogedor. Un salón con un estilo marcadamente contemporáneo e innovador donde la elegancia y la estética se funden',
            'tipo_id' => 1,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'El sabor de la tradición. Grandes momentos en un ambiente cálido y distinguido',
            'tipo_id' => 1,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Un ambiente donde la nobleza de la madera armoniza con el carácter eminentemente mediterráneo que la rodea.',
            'tipo_id' => 1,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Un ambiente moderno y acogedor. Un salón con un estilo marcadamente contemporáneo e innovador donde la elegancia y la estética se funden.',
            'tipo_id' => 1,
            'capacidad_id' => 1
        ...
        Sector::create([
            ...
            'subtitulo' => 'Perfecto para celebraciones al aire libre',
            'tipo_id' => 1,
            'capacidad_id' => 1
